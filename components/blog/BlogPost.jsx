      ...
      <div style={{ background: C.bg.surface, borderBottom: `1px solid ${C.bg.border}`, padding: "clamp(40px,6vw,64px) clamp(16px,5vw,48px) clamp(36px,5vw,56px)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", position: "relative" }}>
          <Link href="/#blog" className="back-link"
            style={{ background: "none", border: "none", fontFamily: FM.mono, fontSize: "12px", cursor: "pointer", marginBottom: "24px", display: "flex", alignItems: "center", gap: "8px", padding: 0, letterSpacing: ".05em", transition: "color .2s", textDecoration: "none", width: "fit-content" }}>
            ← volver al blog
          </Link>
